...
class Tests {
    ...
    fun canBuildFrom() {
        ...
        assertTrue(canBuildFrom(listOf('a', 'b', 'o', '&'), "bao&bab"))
        assertFalse(canBuildFrom(listOf('a', 'm', 'r'), "Marat"))
        assertTrue(canBuildFrom(listOf('3', '-', '&', 'C', 'a', 'l'), "3-&Cal"))
    ...
    fun bagPacking() {
        ...
        assertEquals(setOf("6", "5", "4", "3", "2", "1", "0"),
                bagPacking(mapOf("0" to (68 to 149),
                        "1" to (149 to 475),
                        "2" to (178 to 99),
                        "3" to (88 to 1),
                        "4" to (1 to 179),
                        "5" to (451 to 409),
                        "6" to (149 to 148)), 2505))
